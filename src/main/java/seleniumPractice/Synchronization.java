...
public class Synchronization {
	...
	public static void main(String[] args) {
		...
		// 1. ImplicitelyWait is always applied globally -- is available for all the WebElements.
		// 2. Dynamic in nature
	...
	//These two method I have created to use it for every time I am going to use explicitly wait. Whenever 
	//explicitly wait is needed, I can call this two method to perform explicitly wait without writing three
	//lines of code
