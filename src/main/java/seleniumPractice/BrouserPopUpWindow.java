...
System.setProperty("webdriver.chrome.driver", "/Users/shams/Downloads/chromedriver");
		...
		/*In Set object window/popUp are not stored in the basis of index.
		So, to get the values from Set object we have to use the iterator() method
		this iterator() will return an Iterator of String */		
